...
scene.background = new THREE.Color(0x001133); // Darker blue 
...
loader.load(
    ...
    (gltf) => {
        ...
        submarine.position.set(0, -submarineYOffset, 0); 
...
function animate() {
    ...
    if (submarine) {
        ...
        submarine.position.y = wave - submarineYOffset; 
    }
    ...
    for (let i = 0; i < rainCount; i++) {
        ...
        if (rainPositions[i * 3 + 1] < 0) {
            rainPositions[i * 3 + 1] = 50; // Reset sa taas
        }
    }
